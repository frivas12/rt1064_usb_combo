...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_ENDPOINT_INTERRUPT, USB_SHORT_GET_LOW(HS_CDC_VCOM_INTERRUPT_IN_PACKET_SIZE),
    USB_SHORT_GET_HIGH(HS_CDC_VCOM_INTERRUPT_IN_PACKET_SIZE), HS_CDC_VCOM_INTERRUPT_IN_INTERVAL,
#endif
