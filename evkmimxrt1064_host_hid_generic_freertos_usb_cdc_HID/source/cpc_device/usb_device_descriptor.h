...
#define  THORLABS_USB_DEVICE_VID        (0x2003U)
#define  THORLABS_MCM6000_PID           (0x2003U)

#define USB_DEVICE_VID (THORLABS_USB_DEVICE_VID)
#define USB_DEVICE_PID (THORLABS_MCM6000_PID)
