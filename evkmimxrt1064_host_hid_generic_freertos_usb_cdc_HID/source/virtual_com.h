...
/* @TEST_ANCHOR */
/* Use USB_OTG1 (micro-B) for the CDC device so the host stack can own USB_OTG2. */
...
#define CDC_DEVICE_USB_TASK_PRIORITY (tskIDLE_PRIORITY + 5)
#define CDC_DEVICE_APP_TASK_PRIORITY (CDC_DEVICE_USB_TASK_PRIORITY - 1)
