...
typedef enum
{
	SE0 = 0, /* USB device disconnected*/
	SE1, /* illegal state */
	FSHOST, /* full speed device connected */
	LSHOST, /* low speed device connected */
	NO_CHANGE /* no interrupt detect so return no change */
} usb_host_bus_states;

typedef struct
{
	bool lowspeed;
	usb_host_bus_states bus_state;
...
#endif /* SRC_SYSTEM_DRIVERS_USB_HOST_MAX3421E_H_ */
